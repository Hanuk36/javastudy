...
public class Ex08 {
	...
	public static void main(String[] args) {
		...
		//데이터를 직접 출력하거나 호출하지말고 변수를 이용해서 출력하거나 호출하자.
		...
		result = su1 / su2;
		System.out.println("결과1: " + su1 + " / " + su2 + " = " + result);
		
		double result2 = su1 / su2;
		System.out.println("결과2: " + su1 + " / " + su2 + " = " + result2);
		
		//정수와 실수가 산술연산을 하면 결과는 실수가 된다.
		double result3 = su1 / (su2 * 1.0);
		//double result3 = (double)su1 / su2;
		System.out.println("결과3: " + su1 + " / " + su2 + " = " + result3);
