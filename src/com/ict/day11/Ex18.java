...
public class Ex18 {
	...
	public static void main(String[] args) {
		...
		// 년, 월, 일, 시, 분, 초, 요일 => 시스템상의 년,월,일,시,분,초 이다.
		System.out.println(date.getYear() + 1900 + "년"); // 컴퓨터의 모든 시간은 1900년 1월 1일 0시 0초부터 기준으로 한다.
		// 현재년도 - 1900 = 124. 그래서 124 이다.
		System.out.println(date.getMonth() + 1 + "월"); // 0월~11월 그래서 +1 을 해줘야 1월이 된다.
